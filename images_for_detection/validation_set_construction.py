...
lbl_folder = './labels'  # 标签文件夹路径

train_img_folder = './images/train'  # 训练集图片文件夹路径
val_img_folder = './images/val'  # 验证集图片文件夹路径
train_lbl_folder = './labels/train'  # 训练集标签文件夹路径
val_lbl_folder = './labels/val'  # 验证集标签文件夹路径
